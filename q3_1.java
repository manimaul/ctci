//describe you could use a single array to implement 3 stacks

class q3_1 {
	public static void main(String[] args) {
		TripleStackArray tsa = new TripleStackArray(3);
		try {
			tsa.push("stack # 3", 3);
			tsa.push("from ", 3);
			tsa.push("greetings ", 3);
			...
			System.out.print(tsa.pop(1));
			System.out.print(tsa.pop(1));
			System.out.print(tsa.pop(1));
			System.out.print(tsa.pop(2));
			System.out.print(tsa.pop(2));
			System.out.print(tsa.pop(2));
			System.out.print(tsa.pop(3));
			System.out.print(tsa.pop(3));
			System.out.print(tsa.pop(3));
			System.out.println();
			...
			System.out.print(tsa.peek(1));
			System.out.print(tsa.peek(2));
			System.out.print(tsa.peek(3));
